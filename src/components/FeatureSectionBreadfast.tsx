...
const data = [
  ...
  { id: 4, img: "product__4.webp", name: "Almond organic", price: "$100" },
];

const FeatureSectionBreadfast = () => {
  return (
      ...
      <div className="lg:flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Buy best quality breakfast online in your basket.
          </p>
        </div>
...
export default FeatureSectionBreadfast
